...
<html>
    ...
    <body>
        ...
        <h1>Creacion de Nuevo Genero</h1>
            <div class="col-6">
                ...
                <form action="GeneroControlador">
                    <div class="row">
                        <div class="col-6 form-group">
                            <label>Nombre Genero</label>
                            <input type="text" name="txtNombre" class="form-control" value="${genero.nombre_genero}" placeholder="Ingrese nombres de genero"><span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                        </div>
                    </div>
                    <div class="row col-6 mr-0 pr-0">
                        <div class="col-6  form-group text-left pl-0 ml-0">
                            <a class="btn btn-info w-75" href="${contextPath}/GeneroControlador?accion=listar">Regresar a Lista</a>
                        </div>
