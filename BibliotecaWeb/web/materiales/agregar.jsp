                ...
                <form action="MaterialControlador">
                    ...
                    <div class="row">
                        <div class="col-6 form-group">
                            ...
                            <select name="txtRol" class="form-control" id="exampleFormControlSelect1" value="${materiales.tipoMaterial}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 form-group">
                            <label for="exampleFormControlSelect1">Seleccione editorial</label>
                            <select name="txtRol" class="form-control" id="exampleFormControlSelect1" value="${materiales.editorial}">
                                <option value=""> - Seleccione un rol del listado - </option>
                                <%
                                    EditorialDAO editorialdao = new EditorialDAO();
                                    List<Editorial> list2 = editorialdao.listar();
                                    Iterator<Editorial> iter2 = list2.iterator();
                                    Editorial editorial = null;
                                    while(iter2.hasNext()){
                                        editorial = iter2.next();
                                %>
